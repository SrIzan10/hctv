...
9. Open `Video` and set the output resolution to `1280x720` and the frame rate to `30 FPS`. This should be the best balance between quality and performance for users around the world.
