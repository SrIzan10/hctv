...
#### Go back to the website and regenerate your stream key.

Go back to the website and click this <img alt="Lock Icon" src="/guides/lock.png" width="35" /> icon to regenerate your stream key. Copy the new key and paste it into the `Stream Key` box in OBS.
