...
![Animated GIF of opening the settings page](../../../assets/obs-open-settings-op.gif)

- In the Settings popup, open `Stream` from the sidebar.

- Set `Service` to `Custom...`.

![Animated GIF of opening 'Stream' settings and changing to 'Custom'](../../../assets/obs-changing-settings-op.gif)
